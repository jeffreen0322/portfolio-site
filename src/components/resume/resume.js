  ...
  return (
    <div className="resume-container" id="resume">
      ...
      <header style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <p>
          <a className="res-link" href="mailto:jeffreyenguyen@gmail.com">
            jeffreyenguyen@gmail.com
          </a>{" "}
          |{" "}
          <a
            className="res-link"
            href="https://linkedin.com/in/jeffrey-ethan-nguyen-828a04217/"
            target="_blank"
          ...
          <a
            className="res-link"
            href="https://github.com/jeffreen0322"
            target="_blank"
            rel="noopener noreferrer"
          >
            GitHub
      ...
      <section style={{ marginBottom: "20px" }}>
        ...
        <ul>
          <li>
            User Interaction Software, Introduction to Data Management, Project
            in Databases and Web Applications, Information Retrieval, Data
            Structures Implementation and Analysis, Human Computer Interaction,
            Software Design: Applications, Next Generation Search Systems
          </li>
        </ul>
      </section>
      ...
      <section style={{ marginBottom: "20px" }}>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Hosted on GitHub Pages, featuring projects, repositories, socials,
              and skills.
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            <li>
              Developed a website for browsing and searching anime/manga titles
              using the Jikan API.
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              Designed a sleep tracking application with calendar-based logging
              and local storage.
            </li>
            <li>
